"""
Submit a FASTA file to Phobius via the EBI REST API, poll until complete,
...
BASE_URL = "https://www.ebi.ac.uk/Tools/services/rest/phobius"
...
def main():
    parser = argparse.ArgumentParser(
        description="Submit a FASTA file to EBI Phobius and save results."
    )
    ...
    out_file = args.output_dir / f"{args.fasta.stem}_phobius_{job_id}.txt"
